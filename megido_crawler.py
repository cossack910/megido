...
def megidoimages_get_request(soup, megido_name, url):
    item_image = soup.select_one('.item-image img')
    link_img = item_image.get("src")
    mkdir_path = 'megdo_img/'
...
def megido_crawler():
    ...
    while megido_name != None:
        ...
        megidoimages_get_request(soup, megido_section_title, url)
